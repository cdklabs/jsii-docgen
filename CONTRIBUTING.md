...
- [ ] Title and Description
  - **Change type**: title prefixed with **fix**, **feat** and module name in
    parens, which will appear in changelog. Alternatively, a title prefixed with
    **chore**, which will not appear in the changelog.
...
The following tools need to be installed on your system prior to building `jsii-docgen` locally:

- [Node.js >= 16.19.0](https://nodejs.org/download/release/latest-v16.x/)
...
4. Build (will also run tests)
   - `npx projen build`
3. If you want to run the tests separately, you can do so with:
   - `npx projen compile`
   - `npx projen test`
